...
from ._context_index import ContextIndex
from ._expansion_layer import ExpansionLayer
from ._feedback_layer import FeedbackLayer
from ._identity_layer import IdentityLayer
from ._prompt_budget import apply_prompt_budget
from ._prompt_dedupe import dedupe_sections
from ._state_layer import StateLayer
from ._surface_layer import SurfaceLayer


class PromptAssembler:
    def __init__(self, context_root: Path, *, max_prompt_chars: int = 18_000):
        self.index = ContextIndex(context_root)
