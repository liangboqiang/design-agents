...
from ctx.indexes.context_index import ContextIndex
from ctx.policies.prompt_budget import apply_prompt_budget
from ctx.policies.prompt_dedupe import dedupe_sections
...
class ContextAssembler:
    def __init__(self, ctx_root: Path, *, max_prompt_chars: int = 18_000):
        self.index = ContextIndex(ctx_root)
