...
class MCPStdIOToolbox(Toolbox):
    """Minimal stdio MCP client for common initialize/tools/list/tools/call servers."""

    def __init__(self, command: list[str], toolbox_name: str | None = None, cwd: Path | None = None):
        self.command = command
        self.toolbox_name = toolbox_name or f"mcp_{Path(command[0]).stem}"
        self.cwd = cwd
    ...
    def _ensure_proc(self) -> None:
        ...
        self._request(
            "initialize",
            {
                ...
                "clientInfo": {"name": "fcla-engine", "version": "0.1.0"},
                "capabilities": {},
            },
        )
